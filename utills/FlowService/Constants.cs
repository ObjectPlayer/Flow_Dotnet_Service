namespace FlowServiceConstants
{
    public static class Constants
    {

        public static class FlowTestingServiceConstants
        {
            ...
            public const string testingEventName = "A.cb2d04fc89307107.JoyrideMultiToken";
